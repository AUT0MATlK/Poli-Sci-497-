...
plot(nb_model$param[1,], nb_model_sm$param[1,], xlim = c(0,0.02), ylim = c(0,0.02), xlab="No Smooth", ylab="Smooth", prior = "docfreq") + abline(a = 0, b = 1, col = "red")
...
It doesn't have as many features to run so there will be poorer performance.
...
I was right this should change the outcome. 
